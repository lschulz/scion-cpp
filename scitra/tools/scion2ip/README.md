...
Both can be set or replaced during conversion using the `-p` and `-s` option, respectively. Note
that these options have no effect when converting IPv4 addresses.
