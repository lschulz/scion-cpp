...
# sudo ip mptcp endpoint add fd03::1 dev vethA subflow
```

Host 1:
```bash
sudo ip mptcp endpoint flush
sudo ip mptcp endpoint add fc00:10fc:200::ffff:a80:402 dev scion signal
sudo ip mptcp endpoint add fd00::1 dev scion signal
sudo ip mptcp endpoint add fd00::2 dev scion signal
# sudo ip mptcp endpoint add fd03::2 dev vethB signal
```
